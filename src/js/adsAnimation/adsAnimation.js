...
module.exports = function(events){
	...
	var draw = SVG('game_ads_iphone').size(stage.width, stage.height);
	var mainGroup = draw.group();
	var iphone = mainGroup.group().svg(rawObjects.iphone);

	var imagesGroup = mainGroup.group();
	var img1 = imagesGroup.group().svg(rawObjects.img1);
	var img2 = imagesGroup.group().svg(rawObjects.img2);
